...
replacements = {
    ...
    "Войти в Open WebUI по LDAP": f"Вход в {brand_name}",
    "Sign in to Open WebUI with LDAP": f"Вход в {brand_name}",
    "Login to Open WebUI with LDAP": f"Вход в {brand_name}",
    f"Sign in to {brand_name} with LDAP": f"Вход в {brand_name}",
    f"Войти в {brand_name} по LDAP": f"Вход в {brand_name}",
    "Enter Your Username": "Введите логин",
    "EnterYour Username": "Введите логин",
    "Username": "Логин",
    "Enter Your Password": "Введите пароль",
    "EnterYour Password": "Введите пароль",
    "Password": "Пароль",
