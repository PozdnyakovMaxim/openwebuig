...
- full_document: пользователь явно просит показать, вывести или прочитать полный текст конкретного документа. В поле document_query верни только название, индекс или имя файла этого документа без слов просьбы.
